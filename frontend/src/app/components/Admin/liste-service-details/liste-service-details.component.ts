...
console.log(data);
  ...
  onEdit(serviceId: string): void {
    this.router.navigate(['admin/menu/modifier-services-details', serviceId]); // Redirige vers la page de modification avec l'ID
  }
  ...
  onManageTasks(detailId: string) {
    this.router.navigate([`admin/menu/liste-tache-services-details/${detailId}`]);
  }
  onAdd() {
    this.router.navigate([`admin/menu/services-details`]);
  }
  onManageQuotes(detailId: string) {
    this.router.navigate([`admin/menu/liste-devis/${detailId}`]);
